...
#Add-Type -MemberDefinition $WinAPI -Name "GetCommandLine" -Namespace "WinAPI"
#Add-Type -MemberDefinition $WinAPI -Name "GetProcessParametersString" -Namespace "WinAPI" 
